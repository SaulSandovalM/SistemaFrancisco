  ...
  render() {
    return (
      <div className="background">
          ...
          <div className="full-usecase__main">
            <div className="full-usecase__content">
              <div className="usecase-blurb">
                <p><b>Usa Tiny&nbsp;Authentication para ofrecerles a los usuarios un proceso de acceso intuitivo y rápido.</b> Dales a los usuarios la opción de acceder con su cuenta que la escuela proporcionara. Te tomará menos de 5&nbsp;minutos de trabajo.</p>
                <p><b>Haz un seguimiento de cada paso de tu flujo de incorporación para mejorar la experiencia.</b> Usa Tiny&nbsp;para registrar eventos en cada paso de tu flujo de incorporación, crea embudos para ver dónde abandonan los usuarios.</p>
              </div>
            </div>
            <div className="full-usecase__image">
        ...
        <div className="firesite-row__inner see-features">
          <div className="firesite-row-header__title">
            Explora cada una de nuestras potentes herramientas listas para usar.
          </div>
          <div className="full-usecase__main">
